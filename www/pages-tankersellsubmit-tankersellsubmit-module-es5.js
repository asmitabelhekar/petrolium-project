...
var TankersellsubmitPageRoutingModule = /** @class */ (function () {
    function TankersellsubmitPageRoutingModule() {
    }
    ...
    return TankersellsubmitPageRoutingModule;
}());
...
var TankersellsubmitPageModule = /** @class */ (function () {
    function TankersellsubmitPageModule() {
    }
    ...
    return TankersellsubmitPageModule;
}());
...
var TankersellsubmitPage = /** @class */ (function () {
    function TankersellsubmitPage(menu) {
        this.menu = menu;
        this.tankerSellModel = {};
        this.menu.enable(true);
    }
    TankersellsubmitPage.prototype.ngOnInit = function () {
    };
    TankersellsubmitPage.prototype.OnInput = function (event) {
...
//# sourceMappingURL=pages-tankersellsubmit-tankersellsubmit-module-es5.js.map