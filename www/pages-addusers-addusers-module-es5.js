...
var AddusersPageRoutingModule = /** @class */ (function () {
    function AddusersPageRoutingModule() {
    }
...
var AddusersPage = /** @class */ (function () {
    function AddusersPage(alertController, router, apiCall, events, location, route, toast, loader) {
    ...
    AddusersPage.prototype.ngOnInit = function () {
    ...
    AddusersPage.prototype.goBackword = function () {
        if (this.checkStatus == "add") {
            this.displayAlert();
        }
    ...
    AddusersPage.prototype.selectUserRoleDetail = function (userId) {
        this.userModel['userRole'] = userId;
        // alert(this.userModel['userRole']);
    };
    AddusersPage.prototype.displayCloseAlert = function () {
    ...
    AddusersPage.prototype.displayAlert = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    AddusersPage.prototype.addUserData = function () {
        var _this = this;
        this.loader.presentLoading();
        var send_date = {};
        this.mobieNumber = this.userModel['mobile'];
        var fullName = this.userModel['fname'] + " " + this.userModel['lname'];
        ...
        if (this.checkStatus == "add") {
            ...
            this.apiCall.postWAu(this.url, send_date).subscribe(function (MyResponse) {
                ...
                if (checkUser == '0') {
                    _this.events.publish('Event-UpdateProfile');
                    ...
                    _this.events.publish('Event-AddUser');
                    _this.router.navigate(['/userslist']);
                }
                else {
                    _this.events.publish('Event-AddUser');
    ...
    AddusersPage.prototype.presentToast = function (message) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var toast;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    AddusersPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-addusers-addusers-module-es5.js.map