...
var UserprofilePage = /** @class */ (function () {
    function UserprofilePage(apiCall, router) {
    ...
    UserprofilePage.prototype.getProfileDetail = function () {
        var _this = this;
        var userId = localStorage.getItem('userId');
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].base_url + "users/" + userId;
        console.log("url :" + url);
