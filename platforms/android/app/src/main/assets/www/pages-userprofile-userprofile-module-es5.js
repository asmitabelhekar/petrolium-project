...
var UserprofilePage = /** @class */ (function () {
    function UserprofilePage(apiCall, router, alertController, events, location, activatedRoute) {
    ...
    UserprofilePage.prototype.ngOnInit = function () {
        ...
        this.events.subscribe('Event-UpdateProfile', function () {
            _this.getProfileDetail(_this.userId);
        });
    };
    UserprofilePage.prototype.getProfileDetail = function (id) {
        var _this = this;
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].base_url + "users/" + id;
        console.log("url :" + url);
        this.apiCall.get(url).subscribe(function (MyResponse) {
            _this.getUserDetail = (MyResponse['result']);
            _this.userName = _this.getUserDetail.name;
            _this.userMobile = _this.getUserDetail.mobile;
            _this.userRole = _this.getUserDetail.userRole;
            _this.userEmail = _this.getUserDetail.email;
            _this.userPassword = _this.getUserDetail.password;
            _this.firstName = _this.userName.charAt(0);
        }, function (error) {
        });
    };
    UserprofilePage.prototype.displayAlert = function () {
    ...
    UserprofilePage.prototype.goBackword = function () {
        var checkUser = localStorage.getItem('userRole');
        if (checkUser == '0') {
...
//# sourceMappingURL=pages-userprofile-userprofile-module-es5.js.map